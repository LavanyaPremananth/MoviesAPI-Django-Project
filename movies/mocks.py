...
class Mocks():
    ...
    def create_movies(self):
        # Create mock movie entries using bulk_create
        Movies.objects.bulk_create(
            [
                # Mock movie entries with different attributes
        ...
        # Retrieve the ID of the first movie entry for reference
        id_movies = Movies.objects.values("id").first()
        
        # Return the ID of the first movie entry
        return id_movies
